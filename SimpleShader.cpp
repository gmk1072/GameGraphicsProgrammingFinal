...
// --------------------------------------------------------
// Sets a variable by name with arbitrary data of the specified size
// Data must be packed to 4 bytes but not cross 16 bytes. Must be
// 16 byte aligned. Provide additional padding in struct.
...
// exist or sizes don't match
// --------------------------------------------------------
bool ISimpleShader::SetDataAligned(std::string name, const void * data, unsigned int size)
{
